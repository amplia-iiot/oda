...
public class OperationSetDeviceParametersImplTest {
    ...
    private static final Set<DatastreamValue> TEST_DATASTREAM_VALUES = new HashSet<>(
            Arrays.asList(
                    new DatastreamValue(TEST_DEVICE_ID, TEST_DATASTREAM_ID_1, null, TEST_AT, TEST_VALUE_1, DatastreamValue.Status.OK, null, false, false),
                    new DatastreamValue(TEST_DEVICE_ID, TEST_DATASTREAM_ID_2, null, TEST_AT, TEST_VALUE_2, DatastreamValue.Status.OK, null, false, false),
