...
public class RequestSetDeviceParameters extends Request {

    private final List<Parameter> parameters;

    public RequestSetDeviceParameters(String id, String deviceId, Long timestamp, List<Parameter> parameters) {
