...
public class MessageLoggerInterceptorTest {
    ...
    public void testSendRequest() {
        ...
        verify(mockedLogger).debug(anyString(), eq(REQUEST_MESSAGE), eq(TEST_ADDRESS), eq(TEST_PORT));
        verify(mockedLogger).trace(anyString(), eq(REQUEST_MESSAGE), eq(TEST_REQUEST));
    }
    ...
    public void testSendResponse() {
        ...
        verify(mockedLogger).debug(anyString(), eq(RESPONSE_MESSAGE), eq(TEST_ADDRESS), eq(TEST_PORT));
        verify(mockedLogger).trace(anyString(), eq(RESPONSE_MESSAGE), eq(TEST_RESPONSE));
    }
    ...
    public void testSendEmptyMessage() {
        ...
        verify(mockedLogger).debug(anyString(), eq(EMPTY_MESSAGE), eq(TEST_ADDRESS), eq(TEST_PORT));
        verify(mockedLogger).trace(anyString(), eq(EMPTY_MESSAGE), eq(TEST_EMPTY_MESSAGE));
    }
