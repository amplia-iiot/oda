...
public class HttpClientFactoryImpl implements HttpClientFactory {
    ...
    public void loadConfiguration(HttpClientConfiguration config) {
    ...
    public HttpClientImpl createHttpClient(boolean insecure) {
        return new HttpClientImpl(this.httpClientConfig, insecure);
    }
    ...
    public es.amplia.oda.core.commons.http.HttpResponse post(String url, byte[] payload, String contentType, Map<String, String> headers, boolean compress, boolean insecure) throws IOException {
        HttpClientImpl client = new HttpClientImpl(this.httpClientConfig, insecure);
    ...
    public es.amplia.oda.core.commons.http.HttpResponse put(String url, byte[] payload, String contentType, Map<String, String> headers, boolean compress, boolean insecure) throws IOException {
        HttpClientImpl client = new HttpClientImpl(this.httpClientConfig, insecure);
    ...
    public es.amplia.oda.core.commons.http.HttpResponse get(String url, Map<String, String> headers, boolean insecure) throws IOException {
        HttpClientImpl client = new HttpClientImpl(this.httpClientConfig, insecure);
    ...
    public es.amplia.oda.core.commons.http.HttpResponse delete(String url, Map<String, String> headers, boolean insecure) throws IOException {
        HttpClientImpl client = new HttpClientImpl(this.httpClientConfig, insecure);
