...
public class BitStringPointInformationSequence extends AbstractMessage {
	...
	private BitStringPointInformationSequence(final ASDUHeader header, final InformationObjectAddress startAddress, final List<Value<Long>> values) {
		super(header);
	...
	public static BitStringPointInformationSequence create (final ASDUHeader header, final InformationObjectAddress startAddress, final List<Value<Long>> values) {
	...
	private static BitStringPointInformationSequence createInternal (final ASDUHeader header, final InformationObjectAddress startAddress, final List<Value<Long>> values) {
		return new BitStringPointInformationSequence(header, startAddress, values);
	}
}
