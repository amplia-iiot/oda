...
public class MeasuredValueNormalizedNoQualitySingleCodec implements MessageCodec {

	@Override
	public Object parse(ProtocolOptions protocolOptions, byte b, ASDUHeader asduHeader, ByteBuf byteBuf) {
		return MeasuredValueNormalizedNoQualitySingle.parse(protocolOptions, b, asduHeader, byteBuf);
	}

	@Override
	public void encode(ProtocolOptions protocolOptions, Object o, ByteBuf byteBuf) {
		((MeasuredValueNormalizedNoQualitySingle) o).encode(protocolOptions, byteBuf);
	}
}
