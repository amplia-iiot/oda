...
@PrepareForTest(MeasuredValueNormalizedTimeSequenceCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueNormalizedTimeSequenceCodecTest {
	...
	private final MeasuredValueNormalizedTimeSequenceCodec codec = new MeasuredValueNormalizedTimeSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueNormalizedTimeSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueNormalizedTimeSequence.create(InformationObjectAddress.DEFAULT, new ASDUHeader(CauseOfTransmission.ACTIVATED,
						ASDUAddress.valueOf(1)), v), buffer);
