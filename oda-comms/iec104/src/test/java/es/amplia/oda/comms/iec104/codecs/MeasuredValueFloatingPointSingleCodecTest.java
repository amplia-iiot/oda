...
@PrepareForTest(MeasuredValueFloatingPointSingleCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueFloatingPointSingleCodecTest {
	...
	private final MeasuredValueFloatingPointSingleCodec codec = new MeasuredValueFloatingPointSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueShortFloatingPointSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueShortFloatingPointSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED, ASDUAddress.valueOf(1)), InformationObjectAddress.DEFAULT, v), buffer);
