...
import es.amplia.oda.comms.iec104.types.MeasuredValueNormalizedSequence;
...
@PrepareForTest(MeasuredValueNormalizedSequenceCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueNormalizedSequenceCodecTest {
	...
	private final MeasuredValueNormalizedSequenceCodec codec = new MeasuredValueNormalizedSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueNormalizedSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueNormalizedSequence.create(InformationObjectAddress.DEFAULT,
