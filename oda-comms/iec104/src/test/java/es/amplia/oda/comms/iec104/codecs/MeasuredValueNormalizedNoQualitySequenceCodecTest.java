...
import es.amplia.oda.comms.iec104.types.MeasuredValueNormalizedNoQualitySequence;
...
@PrepareForTest(MeasuredValueNormalizedNoQualitySequenceCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueNormalizedNoQualitySequenceCodecTest {
	...
	private final MeasuredValueNormalizedNoQualitySequenceCodec codec = new MeasuredValueNormalizedNoQualitySequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueNormalizedNoQualitySequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueNormalizedNoQualitySequence.create(InformationObjectAddress.DEFAULT,
