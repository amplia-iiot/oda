...
@PrepareForTest(SinglePointInformationTimeSequenceCodec.class)
public class SinglePointTimeSequenceCodecTest {
	...
	private final SinglePointInformationTimeSequenceCodec codec = new SinglePointInformationTimeSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof SinglePointInformationTimeSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, SinglePointInformationTimeSequence.create(InformationObjectAddress.DEFAULT,
