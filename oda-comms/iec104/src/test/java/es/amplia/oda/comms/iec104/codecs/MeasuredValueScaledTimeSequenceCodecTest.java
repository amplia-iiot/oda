...
import es.amplia.oda.comms.iec104.types.MeasuredValueScaledTimeSequence;
...
@PrepareForTest(MeasuredValueScaledTimeSequenceCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueScaledTimeSequenceCodecTest {
	...
	private final MeasuredValueScaledTimeSequenceCodec codec = new MeasuredValueScaledTimeSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueScaledTimeSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueScaledTimeSequence.create(new ASDUHeader(CauseOfTransmission.ACTIVATED, ASDUAddress.valueOf(1)), InformationObjectAddress.DEFAULT, v), buffer);
