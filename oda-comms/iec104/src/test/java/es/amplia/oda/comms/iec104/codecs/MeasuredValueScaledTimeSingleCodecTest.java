...
@PrepareForTest(MeasuredValueScaledTimeSingleCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueScaledTimeSingleCodecTest {
	...
	private final MeasuredValueScaledTimeSingleCodec codec = new MeasuredValueScaledTimeSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueScaledTimeSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueScaledTimeSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED, ASDUAddress.valueOf(1)), InformationObjectAddress.DEFAULT, v), buffer);
