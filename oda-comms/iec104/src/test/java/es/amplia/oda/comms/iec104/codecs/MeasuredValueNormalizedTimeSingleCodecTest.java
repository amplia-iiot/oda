...
import es.amplia.oda.comms.iec104.types.MeasuredValueNormalizedTimeSingle;
...
@PrepareForTest(MeasuredValueNormalizedTimeSingleCodec.class)
public class MeasuredValueNormalizedTimeSingleCodecTest {
	...
	private final MeasuredValueNormalizedTimeSingleCodec codec = new MeasuredValueNormalizedTimeSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueNormalizedTimeSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueNormalizedTimeSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED,
