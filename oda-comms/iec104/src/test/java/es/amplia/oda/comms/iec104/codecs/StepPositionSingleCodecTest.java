...
@PrepareForTest(StepPositionSingleCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class StepPositionSingleCodecTest {
	...
	private final StepPositionSingleCodec codec = new StepPositionSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof StepPositionSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, StepPositionSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED,
