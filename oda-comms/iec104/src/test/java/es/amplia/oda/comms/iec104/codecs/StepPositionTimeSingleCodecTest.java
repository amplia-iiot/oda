...
@PrepareForTest(StepPositionTimeSingleCodec.class)
public class StepPositionTimeSingleCodecTest {
	...
	private final StepPositionTimeSingleCodec codec = new StepPositionTimeSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof StepPositionTimeSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, StepPositionTimeSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED,
