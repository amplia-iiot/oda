...
@PrepareForTest(DoublePointInformationTimeSequenceCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class DoublePointSequenceTimeCodecTest {
	...
	private final DoublePointInformationTimeSequenceCodec codec = new DoublePointInformationTimeSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof DoublePointInformationTimeSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, DoublePointInformationTimeSequence.create(InformationObjectAddress.DEFAULT,
