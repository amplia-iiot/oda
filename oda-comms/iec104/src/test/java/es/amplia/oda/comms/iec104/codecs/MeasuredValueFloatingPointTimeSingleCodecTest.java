...
@PrepareForTest(MeasuredValueFloatingPointTimeSingleCodec.class)
@PowerMockIgnore("jdk.internal.reflect.*")
public class MeasuredValueFloatingPointTimeSingleCodecTest {
	...
	private final MeasuredValueFloatingPointTimeSingleCodec codec = new MeasuredValueFloatingPointTimeSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueShortFloatingPointTimeSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueShortFloatingPointTimeSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED,
