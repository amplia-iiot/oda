...
import es.amplia.oda.comms.iec104.types.StepPositionTimeSequence;
...
public class StepPositionTimeSequenceCodecTest {
	...
	private final StepPositionTimeSequenceCodec codec = new StepPositionTimeSequenceCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof StepPositionTimeSequence);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, StepPositionTimeSequence.create(InformationObjectAddress.DEFAULT,
