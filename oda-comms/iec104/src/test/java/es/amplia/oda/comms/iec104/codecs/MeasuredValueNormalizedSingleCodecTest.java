...
@PrepareForTest(MeasuredValueNormalizedSingleCodec.class)
public class MeasuredValueNormalizedSingleCodecTest {
	...
	private final MeasuredValueNormalizedSingleCodec codec = new MeasuredValueNormalizedSingleCodec();
	...
	public void testParse() {
		...
		assertTrue(o instanceof MeasuredValueNormalizedSingle);
	}
	...
	public void testEncode() {
		...
		codec.encode(options, MeasuredValueNormalizedSingle.create(new ASDUHeader(CauseOfTransmission.ACTIVATED,
