...
public class TemperatureValueDatastreamGetterTest {
	...
	public void testGetDatastreamIdSatisfied() {
		assertEquals(DeviceInfoDatastreamsGetter.TEMPERATURE_VALUE_DATASTREAM_ID, datastreamGetter.getDatastreamIdSatisfied());
	}
	...
	public void testGetException() throws ExecutionException, InterruptedException {
		when(deviceInfoFX30.getTemperatureValue()).thenThrow(mockedNumberFormatException);
