...
public class IccDatastreamGetter implements DatastreamsGetter {

	private DeviceInfoFX30 deviceInfo;

	public IccDatastreamGetter(DeviceInfoFX30 deviceInfo) {
		this.deviceInfo = deviceInfo;
	}

	@Override
	public String getDatastreamIdSatisfied() {
		return DeviceInfoFX30.ICC_DATASTREAM_ID;
	}
	...
	public CompletableFuture<CollectedValue> get(String device) {
		return CompletableFuture.completedFuture(
				new CollectedValue(System.currentTimeMillis(), Optional.ofNullable(this.deviceInfo.getIcc()).orElse(""))
		);
	}
}