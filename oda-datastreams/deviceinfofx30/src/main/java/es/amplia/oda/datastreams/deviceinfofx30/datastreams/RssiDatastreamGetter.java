...
public class RssiDatastreamGetter implements DatastreamsGetter {

	private DeviceInfoFX30 deviceInfo;

	public RssiDatastreamGetter(DeviceInfoFX30 deviceInfo) {
		this.deviceInfo = deviceInfo;
	}

	@Override
	public String getDatastreamIdSatisfied() {
		return DeviceInfoFX30.RSSI_DATASTREAM_ID;
	}
	...
	public CompletableFuture<CollectedValue> get(String device) {
		return CompletableFuture.completedFuture(
				new CollectedValue(System.currentTimeMillis(), Optional.ofNullable(this.deviceInfo.getRssi()).orElse(""))
		);
	}
}
