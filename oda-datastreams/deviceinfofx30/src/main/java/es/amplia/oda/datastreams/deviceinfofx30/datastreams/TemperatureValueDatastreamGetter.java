...
public class TemperatureValueDatastreamGetter implements DatastreamsGetter {
	...
	public TemperatureValueDatastreamGetter(DeviceInfoFX30 deviceInfo) {
		this.deviceInfo = deviceInfo;
	}

	@Override
	public String getDatastreamIdSatisfied() {
		return DeviceInfoFX30.TEMPERATURE_VALUE_DATASTREAM_ID;
	}
	...
	public CompletableFuture<CollectedValue> get(String device) {
		return CompletableFuture.completedFuture(
				new CollectedValue(System.currentTimeMillis(), Optional.ofNullable(this.deviceInfo.getTemperatureValue()).orElse(""))
		);
	}
}
