...
public class CollectorImplTest {
    ...
    public void testCollect() {
        DatastreamValue dv1 =
                new DatastreamValue(TEST_DEVICE_ID_1, TEST_DATASTREAM_ID_1, null, TEST_AT_1, TEST_VALUE_1, Status.OK, null, false, true);
        DatastreamValue dv2 =
                new DatastreamValue(TEST_DEVICE_ID_1, TEST_DATASTREAM_ID_2, null, TEST_AT_2, TEST_VALUE_2, Status.OK, null, false, true);
        DatastreamValue dv3 =
                new DatastreamValue(TEST_DEVICE_ID_2, TEST_DATASTREAM_ID_2, null, TEST_AT_2, TEST_VALUE_2, Status.OK, null, false, true);
        DatastreamValue dv4 =
