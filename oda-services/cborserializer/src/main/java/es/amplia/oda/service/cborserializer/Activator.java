...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		serializerProps.put(Serializer.TYPE_PROPERTY_NAME, Serializer.SERIALIZER_TYPE.CBOR.toString());
		registration = bundleContext.registerService(CborSerializer.class.getName(), cborSerializer, serializerProps);
